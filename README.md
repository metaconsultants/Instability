...
As Euler reported long back when an elastic solid is compressed, after reaching a critical load value it buckles. Here we are adding a summary of buckling that is simulated by us in <code> Abaqus </code> .  
